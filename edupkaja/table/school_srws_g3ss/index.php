...
<thead>
 <tr>
	...
	<th colspan=12 align="center"><strong>Grade 10</strong></th>
	<th colspan=12 align="center"><strong>Grade 11</strong></th>
	<th colspan=12 align="center"><strong>Grade 11R</strong></th>
	
	<th colspan=14 align="center"><strong>10 - 11 Total</strong></th>
	<th rowspan=2 align="center"><strong>Last Updated</strong></th>
	<tr>
	<th class="rotate"><div>ICT</div></th>
	<th class="rotate"><div>Agriculture & Foodtechnology</div></th>
	<th class="rotate"><div>Fisheries & Food Technology</div></th>
	<th class="rotate"><div>Design & Technology</div></th>
	<th class="rotate"><div>Arts & Crafts</div></th>
	<th class="rotate"><div>Home Economics</div></th>
	<th class="rotate"><div>Health & Physical Education</div></th>
	<th class="rotate"><div>Communication & Media Studies</div></th>
	<th class="rotate"><div>Electronic & Writing Shorthand English</div></th>
	<th class="rotate"><div>Electronic & Writing Shorthand Tamil</div></th>
	<th class="rotate"><div>Electronic & Writing Shorthand Sinhala</div></th>
	<th class="rotate"><div>3rd Group Subject Total</div></th>
...
$sql = "SELECT * FROM schdata GROUP BY Division ORDER BY Division";
   ...
   <script language="javascript">
       function open_win_editar(targetID) {
           window.open ("table/school_srws_g3ss/hasil.php?id=" + targetID, "MsgWindow","Editar notícia", "location=1, status=1, scrollbars=1, width=800, height=200");
        }
...
<script src="table/school_srws_g3ss/table_box.js"></script>
