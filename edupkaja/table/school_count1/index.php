...
<thead>
 <tr>
	<th align="center"><strong>Zone</strong></th>
	<th align="center"><strong>National</strong></th>
	<th align="center"><strong>Provincial</strong></th>
	<th align="center"><strong>Private</strong></th>
	<th align="center"><strong>Total Schools</strong></th>
	<th align="center"><strong>Function School</strong></th>
	<th align="center"><strong>1AB</strong></th>
	<th align="center"><strong>1C</strong></th>
	<th align="center"><strong>II</strong></th>
	<th align="center"><strong>III</strong></th>
	</tr> 
  </thead>
<tbody>
<?php
	include('table/school_count1/db.php');
...
$sql="SELECT CenID, Scid, SchoolName, SchoolAddress, Telephone, ContactNo, schdata.Zone, Division, Category, Span, Type, Medium, schdata.Race, SexType, stTotal, sum(if(Service = 'SLTS' or Service = 'TeacherAssist', 1, 0)) as teanos FROM schdata,stafftb,studentpop WHERE NearestSch='1' and Scid=stScid and Scid=SchID Group by Scid Order by ZoneSort, Scid ASC";
   ...
   <script language="javascript">
       function open_win_editar(targetID) {
           window.open ("table/school_count1/hasil.php?id=" + targetID, "MsgWindow","Editar notícia", "location=1, status=1, scrollbars=1, width=800, height=200");
        }
