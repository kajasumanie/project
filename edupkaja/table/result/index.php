...
<script src="table/result/table_box.js"></script>
...
<span class="glyphicon glyphicon-download-alt"></span> Download </button>
     ...
     <div class="modal fade" id="smallModal" tabindex="-1" role="dialog" aria-labelledby="smallModal" aria-hidden="true">
      ...
      <label for="Division">Division</label>
			...
			<a href="index.php?table=result"> reset</a>
...
<thead>
  <tr>
	...
	<th class="tg-mxzp" align='center' rowspan='3'>School ID</th>
	<th class="tg-mxzp" align='center' rowspan='3'>School Name</th>
  <th class="tg-mxzp" align='center' rowspan='3'>School address</th>
	<th class="tg-mxzp" align='center' rowspan='3'>Division</th>
	<th class="tg-mxzp" align='center' rowspan='3'>Zone</th>
	<th class="tg-mxzp" align='center' rowspan='3'>Func</th>
	<th class="tg-mxzp" align='center' rowspan='3'>Type</th>
  ...
  if (isset($_POST['Zone']) && !$_POST['Zone']=='' )
  {
   ...
   <script language="javascript">
       function open_win_editar(targetID) {
           window.open ("table/result/hasil.php?id=" + targetID, "MsgWindow","Editar notícia", "location=1, status=1, scrollbars=1, width=800, height=200");
        }
