...
<thead>
  <tr>
	...
	<th class="tg-mxzp" align='center' colspan=4 >Grade 1-5</th>
	<th class="tg-mxzp" align='center' colspan=4 >Grade 6-11</th>
	<th class="tg-mxzp" align='center' colspan=4 >Grade 12-13</th>
	<th class="tg-mxzp" align='center' colspan=4 >Total</th>
  <th class="tg-mxzp" align='center' colspan=2 >Total</th>
  </tr>
  <tr>
  ...
  <th class="tg-mxzp" align='center' >Spe. Edu. InCentre</th>
	<th class="tg-mxzp" align='center' >Grand Total</th>
...
$sql = "SELECT * FROM schdata GROUP BY Division ORDER BY Division";
   ...
   <script language="javascript">
       function open_win_editar(targetID) {
           window.open ("table/school_dws_gw_ss/hasil.php?id=" + targetID, "MsgWindow","Editar notícia", "location=1, status=1, scrollbars=1, width=800, height=200");
        }
