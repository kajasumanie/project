...
<span class="glyphicon glyphicon-download-alt"></span> Download </button>
     ...
     <div class="modal fade" id="smallModal" tabindex="-1" role="dialog" aria-labelledby="smallModal" aria-hidden="true">
      ...
      <label for="Division">Division</label>
			...
			<a href="index.php?table=student_zone_gws_ss"> reset</a>
...
<thead>
  <tr>
	...
	<th class="tg-mxzp" align='center' >Grade 1-5</th>
	<th class="tg-mxzp" align='center' >Grade 6-11</th>
	<th class="tg-mxzp" align='center' >Grade 12-13</th>
...
<tbody>
<?php
	include('table/school_zws_gw_ss/db.php');
...
$sql = "SELECT * FROM schdata GROUP BY Zone";
   ...
   <script language="javascript">
       function open_win_editar(targetID) {
           window.open ("table/school_zws_gw_ss/view.php?id=" + targetID, "MsgWindow", "toolbar=yes,scrollbars=1,resizable=yes,top=200,left=500,width=500,height=500");
        }
...
<script src="table/school_zws_gw_ss/table_box.js"></script>
