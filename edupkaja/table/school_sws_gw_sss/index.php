...
<script src="table/school_sws_gw_sss/bootstrap.js"></script
...
<span class="glyphicon glyphicon-download-alt"></span> Download </button>
     ...
     <div class="modal fade" id="smallModal" tabindex="-1" role="dialog" aria-labelledby="smallModal" aria-hidden="true">
      ...
      <label for="Division">Division</label>
			...
			<a href="index.php?table=school_sws_gw_sss"> reset</a>
...
<thead>
  <tr>
	<th class="tg-mxzp" align='center' rowspan=2 >No.</th>
  <th class="tg-mxzp" align='center' rowspan=2 >Census ID</th>
  <th class="tg-mxzp" align='center' rowspan=2 >School ID</th>
  <th class="tg-mxzp" align='center' rowspan=2 >School Name</th>
  <th class="tg-mxzp" align='center' rowspan=2 >Division</th>
  <th class="tg-mxzp" align='center' rowspan=2 >Zone</th>
  <th class="tg-mxzp" align='center' rowspan=2 >Race</th>
	<th class="tg-mxzp" align='center' rowspan=2 >Type</th>
	<th class="tg-mxzp" align='center' colspan=4 >Science(Grade-12)</th>
	<th class="tg-mxzp" align='center' colspan=4 >Maths(Grade-12)</th>
  <th class="tg-mxzp" align='center' colspan=4 >Commerce(Grade-12)</th>
  <th class="tg-mxzp" align='center' colspan=4 >Arts(Grade-12)</th>
  <th class="tg-mxzp" align='center' colspan=4 >Technology(Grade-12)</th>
  <th class="tg-mxzp" align='center' colspan=4 >Science(Grade-13)</th>
  <th class="tg-mxzp" align='center' colspan=4 >Maths(Grade-13)</th>
  <th class="tg-mxzp" align='center' colspan=4 >Commerce(Grade-13</th>
  <th class="tg-mxzp" align='center' colspan=4 >Arts(Grade-13)</th>
  <th class="tg-mxzp" align='center' colspan=4 >Technology(Grade-13)</th>
  <th class="tg-mxzp" align='center' colspan=4 >Science(Grade-13R)</th>
  <th class="tg-mxzp" align='center' colspan=4 >Maths(Grade-13R)</th>
  <th class="tg-mxzp" align='center' colspan=4 >Commerce(Grade-13R)</th>
  <th class="tg-mxzp" align='center' colspan=4 >Arts(Grade-13R)</th>
  <th class="tg-mxzp" align='center' colspan=4 >Technology(Grade-13R)</th>

  <th class="tg-mxzp" align='center' colspan=4 >Total</th>
  <th class="tg-mxzp" align='center' rowspan=2 >Last Updated</th>
  </tr>
  <tr>
...
<tbody>
<?php
	include('table/school_sws_gw_sss/db.php');
...
$sql = "SELECT * FROM schdata,studentpop WHERE Scid=stScid and Station='School'";
   ...
   <script language="javascript">
       function open_win_editar(targetID) {
           window.open ("table/school_sws_gw_sss/hasil.php?id=" + targetID, "MsgWindow","Editar notícia", "location=1, status=1, scrollbars=1, width=800, height=200");
        }
...
<script src="table/school_sws_gw_sss/table_box.js"></script>
