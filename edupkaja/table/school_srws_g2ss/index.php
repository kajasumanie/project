...
<thead>
  <tr>
	...
	<th colspan=14 align="center"><strong>Grade 6</strong></th>
	<th colspan=14 align="center"><strong>Grade 7</strong></th>
	<th colspan=14 align="center"><strong>Grade 8</strong></th>
	<th colspan=14align="center"><strong>Grade 9</strong></th>
	<th colspan=14 align="center"><strong>Grade 10</strong></th>
	<th colspan=14 align="center"><strong>Grade 11</strong></th>
	<th colspan=14 align="center"><strong>Grade 11R</strong></th>
	
	<th colspan=14 align="center"><strong>6 - 11 Total</strong></th>
	<th rowspan=2 align="center"><strong>Last Updated</strong></th>
	<tr>
	
	<th class="rotate"><div>Music (Oriental)</div></th>
	<th class="rotate"><div>Music (Western)</div></th>
	<th class="rotate"><div>Music (Carnatic)</div></th>
	<th class="rotate"><div>Art</div></th>
	<th class="rotate"><div>Dancing (Oriental)</div></th>
	<th class="rotate"><div>Dancing (Bharatha)</div></th>
	<th class="rotate"><div>Appreciation of English Literary Texts</div></th>
	<th class="rotate"><div>Appreciation of Tamil Literary Texts</div></th>
	<th class="rotate"><div>Appreciation of Sinhala Literary Texts</div></th>
	<th class="rotate"><div>Appreciation of Arabic Literary Texts</div></th>
	...
	<th class="rotate"><div>2nd Group Subject Total</div></th>
...
$sql = "SELECT * FROM schdata GROUP BY Division ORDER BY Division";
   ...
   <script language="javascript">
       function open_win_editar(targetID) {
           window.open ("table/school_srws_g2ss/hasil.php?id=" + targetID, "MsgWindow","Editar notícia", "location=1, status=1, scrollbars=1, width=800, height=200");
        }
...
<script src="table/school_srws_g2ss/table_box.js"></script>
