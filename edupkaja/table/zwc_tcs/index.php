...
<script src="table/zws_tcs/bootstrap.js"></script
...
<span class="glyphicon glyphicon-download-alt"></span> Download </button>
     ...
     <div class="modal fade" id="smallModal" tabindex="-1" role="dialog" aria-labelledby="smallModal" aria-hidden="true">
      ...
      <label for="Division">Division</label>
			...
			<a href="index.php?table=zws_tcs"> reset</a>
...
<thead>
 <tr>
	...
	<th colspan=4 align="center">Grade 1-5</th>
	<th colspan=4 align="center">Grade 6-11</th>
	<th colspan=4 align="center">Grade 12-13</th>

	<th colspan=4 align="center">Total</th>
	<th rowspan=2 align="center">Spe. Edu. InCentre</th>
	<th rowspan=2 align="center">Grand Total</th>
	<tr>
	<th class="rotate"><div>Male</div></th>
	<th class="rotate"><div>Female</div></th>
	<th class="rotate"><div>Total</div></th>
	<th class="rotate"><div>Parallel Class</div></th>
...
$sql = "SELECT * FROM schdata GROUP BY Division ORDER BY Division";
   ...
   <script language="javascript">
       function open_win_editar(targetID) {
           window.open ("table/zws_tcs/hasil.php?id=" + targetID, "MsgWindow","Editar notícia", "location=1, status=1, scrollbars=1, width=800, height=200");
        }
...
<script src="table/zws_tcs/table_box.js"></script>
