...
<thead>
  <tr>
	...
	<th colspan=14 align="center"><strong>Grade 12 Commerce - 2019</strong></th>
	<th colspan=14 align="center"><strong>Grade 13 Commerce - 2018</strong></th>
	<th colspan=14 align="center"><strong>Grade 13R Commerce - 2017</strong></th>
	<th colspan=6 align="center"><strong>Grade 12 Commerce (Eng) - 2019</strong></th>
	<th colspan=6 align="center"><strong>Grade 13 Commerce (Eng) - 2018</strong></th>
	<th colspan=6 align="center"><strong>Grade 13R Commerce (Eng) - 2017</strong></th>
		
	<th colspan=14 align="center"><strong>Gr12 - 13 Commerce Total (2017-2019)</strong></th>
	<th rowspan=2 align="center"><strong>Last Updated</strong></th>
	<tr>
	<th class="rotate"><div>Business Studies</div></th>
	...
	<th class="rotate"><div>Indian History</div></th>
	<th class="rotate"><div>Europe History </div></th>
	<th class="rotate"><div>Modern World History</div></th>
	<th class="rotate"><div>Logic</div></th>
	<th class="rotate"><div>English</div></th>
	<th class="rotate"><div>AgroScience</div></th>
	<th class="rotate"><div>Combainedmaths</div></th>
	<th class="rotate"><div>ICT</div></th>
	<!--<th class="rotate"><div>Gr12 Commerce Total</div></th>-->
	...
	<th class="rotate"><div>Combainedmaths</div></th>
	<th class="rotate"><div>ICT</div></th>
	<!--<th class="rotate"><div>Gr13 Commerce Total</div></th>-->
	...
	<th class="rotate"><div>Combainedmaths</div></th>
	<th class="rotate"><div>ICT</div></th>
	<!--<th class="rotate"><div>Gr13R Commerce Total</div></th>-->
	...
	<th class="rotate"><div>Political Science</div></th>
	<th class="rotate"><div>AgroScience</div></th>
	<!--<th class="rotate"><div>Commerce Total</div></th>-->
...
$sql = "SELECT * FROM schdata GROUP BY Division ORDER BY Division";
   ...
   <script language="javascript">
       function open_win_editar(targetID) {
           window.open ("table/school_srws_acss/hasil.php?id=" + targetID, "MsgWindow","Editar notícia", "location=1, status=1, scrollbars=1, width=800, height=200");
        }
...
<script src="table/school_srws_acss/table_box.js"></script>
