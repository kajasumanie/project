...
<span class="glyphicon glyphicon-download-alt"></span> Download </button>
     ...
     <div class="modal fade" id="smallModal" tabindex="-1" role="dialog" aria-labelledby="smallModal" aria-hidden="true">
      ...
      <label for="Division">Division</label>
			...
			<a href="index.php?table=school_zws_sw_3ss"> reset</a>
...
<div class="row">
  ...
  <div id="wrapper">
  <table id=""   width="100%" class="tg">
<thead>
  <tr>
	<th class="tg-mxzp" align='center' rowspan=2 >No.</th>
	<th class="tg-mxzp" align='center' rowspan=2 >Zone</th>
	<th class="tg-mxzp" align='left' colspan=12 >10 - 11 Total</th>

  </tr>
  <tr>
  <th class="tg-mxzp rotate" align='center'><div><span>ICT</span></div></th>
	<th class="tg-mxzp rotate" align='center'><div><span>Ag&Food.Tech</span></div></th>
	<th class="tg-mxzp rotate" align='center'><div><span>Fish&Food.Tech</span></div></th>
	<th class="tg-mxzp rotate" align='center'><div><span>Design&Tech</span></div></th>

	<th class="tg-mxzp rotate" align='center'><div><span>Arts&Crafts</span></div></th>
	<th class="tg-mxzp rotate" align='center'><div><span>Home Economics</span></div></th>
	<th class="tg-mxzp rotate" align='center'><div><span>Health&Physical Education</span></div></th>
	<th class="tg-mxzp rotate" align='center'><div><span>Communication&Media Studies</span></div></th>

  <th class="tg-mxzp rotate" align='center'><div><span>Electronic&Writing Shorthand English</span></div></th>
  <th class="tg-mxzp rotate" align='center'><div><span>Electronic&Writing Shorthand Tamil</span></div></th>
  <th class="tg-mxzp rotate" align='center'><div><span>Electronic&Writing Shorthand Sinhala</span></div></th>
  <th class="tg-mxzp rotate" align='center'><div><span>3rd Group Subject Total</span></div></th>
	</tr>
  </thead>
<tbody>
<?php
	include('table/school_zws_sw_3ss/db.php');
...
$sql = "SELECT * FROM schdata GROUP BY Zone ORDER BY Zone";
   ...
   <script language="javascript">
       function open_win_editar(targetID) {
           window.open ("table/school_zws_sw_3ss/hasil.php?id=" + targetID, "MsgWindow","Editar notícia", "location=1, status=1, scrollbars=1, width=800, height=200");
        }
        function graph_editar() {
            window.open ("table/school_zws_sw_3ss/fullview.php", "MsgWindow","Editar notícia", "location=1, status=1, scrollbars=1, width=800, height=200");
         }
   </script>
<script src="table/school_zws_sw_3ss/table_box.js"></script>
