...
<script src="table/school_sws_gw_ss/bootstrap.js"></script
...
<span class="glyphicon glyphicon-download-alt"></span> Download </button>
     ...
     <div class="modal fade" id="smallModal" tabindex="-1" role="dialog" aria-labelledby="smallModal" aria-hidden="true">
      ...
      <label for="Division">Division</label>
			...
			<a href="index.php?table=school_sws_gw_ss"> reset</a>
...
<thead>
  <tr>
	...
	<th colspan=13 align="center"><strong>Grade 12 Technical -2019</strong></th>
	<th colspan=13 align="center"><strong>Grade 13 Technical -2018</strong></th>
	<th colspan=13 align="center"><strong>Grade 13R Technical -2017</strong></th>
		
	<th colspan=13 align="center"><strong>Gr12 - 13 Technical Total</strong></th>
	<th rowspan=2 align="center"><strong>Last Updated</strong></th>
	<tr>
	<th class="rotate"><div>Engineering Technology</div></th>
	<th class="rotate"><div>BioSystem Technology</div></th>
	<th class="rotate"><div>Science for Technology</div></th>
	<th class="rotate"><div>ICT </div></th>
	<th class="rotate"><div>Art</div></th>
	<th class="rotate"><div>BuisnessStudies</div></th>
	<th class="rotate"><div>AgroScience</div></th>
	<th class="rotate"><div>Accounts </div></th>
	<th class="rotate"><div>Economics</div></th>
	<th class="rotate"><div>HomeEconomics</div></th>
	<th class="rotate"><div>Geography</div></th>
	<th class="rotate"><div>English</div></th>
	<th class="rotate"><div>CommuMediaStudies</div></th>
	<!--<th class="rotate"><div>Gr12 Technical Total</div></th>-->
	...
	<th class="rotate"><div>English</div></th>
	<th class="rotate"><div>CommuMediaStudies</div></th>
	<!--<th class="rotate"><div>Gr13 Technical Total</div></th>-->
	...
	<th class="rotate"><div>English</div></th>
	<th class="rotate"><div>CommuMediaStudies</div></th>
	<!--<th class="rotate"><div>Gr13R Technical Total</div></th>-->
	...
	<th class="rotate"><div>English</div></th>
	<th class="rotate"><div>CommuMediaStudies</div></th>
	<!--<th class="rotate"><div>Technical Total</div></th>-->
...
<tbody>
<?php
	include('table/school_sws_gw_ss/db.php');
...
$sql = "SELECT * FROM schdata,studentpop WHERE Scid=stScid and Station='School'";
   ...
   <script language="javascript">
       function open_win_editar(targetID) {
           window.open ("table/school_srws_atss/hasil.php?id=" + targetID, "MsgWindow","Editar notícia", "location=1, status=1, scrollbars=1, width=800, height=200");
        }
...
<script src="table/school_srws_atss/table_box.js"></script>
