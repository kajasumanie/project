...
<span class="glyphicon glyphicon-download-alt"></span> Download </button>
     ...
     <div class="modal fade" id="smallModal" tabindex="-1" role="dialog" aria-labelledby="smallModal" aria-hidden="true">
      ...
      <label for="Division">Division</label>
			...
			<a href="index.php?table=school_sws_gw_ssumary"> reset</a>
...
<thead>
  <tr>
	<th class="tg-mxzp" align='center' rowspan=1 >No.</th>
  <th class="tg-mxzp" align='center' rowspan=1 >Census ID</th>
  <th class="tg-mxzp" align='center' rowspan=1 >School ID</th>
  <th class="tg-mxzp" align='center' rowspan=1 >School Name</th>
  <th class="tg-mxzp" align='center' rowspan=1 >Division</th>
  <th class="tg-mxzp" align='center' rowspan=1 >Zone</th>
  <th class="tg-mxzp" align='center' rowspan=1 >Race</th>
	<th class="tg-mxzp" align='center' rowspan=1 >Type</th>
	<th class="tg-mxzp" align='center' colspan=1 >Male</th>
	<th class="tg-mxzp" align='center' colspan=1 >Female</th>
  <th class="tg-mxzp" align='center' colspan=1 >Total</th>
  <th class="tg-mxzp" align='center' colspan=1 >Spe. Edu. InCentre</th>
  <th class="tg-mxzp" align='center' colspan=1 >Grand Total</th>

  </tr>
    </thead>
<tbody>
<?php
	include('table/school_sws_gw_ssumary/db.php');
...
<script src="table/school_sws_gw_ssumary/table_box.js"></script>
