...
class crud
{
	...
	public function dataview($query)
	{
		...
		<tr>
			...
			<td align="center"><strong><?php echo $g12SciPhy ?></strong></td>
			<td align="center"><strong><?php echo $g12SciChem ?></strong></td>
			<td align="center"><strong><?php echo $g12SciCombMath ?></strong></td>
			<td align="center"><strong><?php echo $g12SciHighMath ?></strong></td>
			<td align="center"><strong><?php echo $g12SciBio ?></strong></td>
			<td align="center"><strong><?php echo $g12SciAgro ?></strong></td>
			<!--<td align="center"><strong><?php echo $g12SciTot ?></strong></td>-->
			
			<td align="center"><strong><?php echo $g13SciPhy ?></strong></td>
			<td align="center"><strong><?php echo $g13SciChem ?></strong></td>
			<td align="center"><strong><?php echo $g13SciCombMath ?></strong></td>
			<td align="center"><strong><?php echo $g13SciHighMath ?></strong></td>
			<td align="center"><strong><?php echo $g13SciBio ?></strong></td>
			<td align="center"><strong><?php echo $g13SciAgro ?></strong></td>
			<!--<td align="center"><strong><?php echo $g13SciTot ?></strong></td>-->
			
			<td align="center"><strong><?php echo $g13RSciPhy ?></strong></td>
			<td align="center"><strong><?php echo $g13RSciChem ?></strong></td>
			<td align="center"><strong><?php echo $g13RSciCombMath ?></strong></td>
			<td align="center"><strong><?php echo $g13RSciHighMath ?></strong></td>
			<td align="center"><strong><?php echo $g13RSciBio ?></strong></td>
			<td align="center"><strong><?php echo $g13RSciAgro ?></strong></td>
			<!--<td align="center"><strong><?php echo $g13RSciTot ?></strong></td>-->
			
			<td align="center"><strong><?php echo $g12SciPhyE ?></strong></td>
			<td align="center"><strong><?php echo $g12SciChemE ?></strong></td>
			<td align="center"><strong><?php echo $g12SciCombMathE ?></strong></td>
			<td align="center"><strong><?php echo $g12SciHighMathE ?></strong></td>
			<td align="center"><strong><?php echo $g12SciBioE ?></strong></td>
			<td align="center"><strong><?php echo $g12SciAgroE ?></strong></td>
			<!--<td align="center"><strong><?php echo $g12SciTotE ?></strong></td>-->
			
			<td align="center"><strong><?php echo $g13SciPhyE ?></strong></td>
			<td align="center"><strong><?php echo $g13SciChemE ?></strong></td>
			<td align="center"><strong><?php echo $g13SciCombMathE ?></strong></td>
			<td align="center"><strong><?php echo $g13SciHighMathE ?></strong></td>
			<td align="center"><strong><?php echo $g13SciBioE ?></strong></td>
			<td align="center"><strong><?php echo $g13SciAgroE ?></strong></td>
			<!--<td align="center"><strong><?php echo $g13SciTotE ?></strong></td>-->
			
			<td align="center"><strong><?php echo $g13RSciPhyE ?></strong></td>
			<td align="center"><strong><?php echo $g13RSciChemE ?></strong></td>
			<td align="center"><strong><?php echo $g13RSciCombMathE ?></strong></td>
			<td align="center"><strong><?php echo $g13RSciHighMathE ?></strong></td>
			<td align="center"><strong><?php echo $g13RSciBioE ?></strong></td>
			<td align="center"><strong><?php echo $g13RSciAgroE ?></strong></td>
			<!--<td align="center"><strong><?php echo $g13RSciTotE ?></strong></td>-->
														
			<td align="center"><strong><?php echo $SciPhy ?></strong></td>
			<td align="center"><strong><?php echo $SciChem ?></strong></td>
			<td align="center"><strong><?php echo $SciCombMath ?></strong></td>
			<td align="center"><strong><?php echo $SciHighMath ?></strong></td>
			<td align="center"><strong><?php echo $SciBio ?></strong></td>
			<td align="center"><strong><?php echo $SciAgro ?></strong></td>
			<!--<td align="center"><strong><?php echo $SciTot ?></strong></td>-->
