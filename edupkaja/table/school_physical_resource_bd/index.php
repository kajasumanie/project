...
<span class="glyphicon glyphicon-download-alt"></span> Download </button>
     ...
     <div class="modal fade" id="smallModal" tabindex="-1" role="dialog" aria-labelledby="smallModal" aria-hidden="true">
      ...
      <label for="Division">Division</label>
			...
			<a href="index.php?table=school_physical_resource_bd"> reset</a>
...
<thead>
	...
	<th align="center">Wash Water</th>
	<th align="center"><Drink Water</th>
	<th align="center">Computer Lab or Corner</th>
	<th colspan=2 align="center">Internet Facility</th>
	<th align="center">Type of Int.Connection</th>
	<th align="center">Internet Service Provider</th>
	<th align="center">Science Lab</th>
	<th align="center"><Maths Room</th>
	<th colspan=2 align="center">Agriculture Lab or Room</th>
	<th align="center">Audio Visual Room</th>
	<th align="center">Councelling Room</th>
	<th align="center">Special Edu Room</th>
	<th align="center">Special Edu Unit</th>
	<th align="center">Assembly Hall</th>
	<th align="center"><Activity Room</th>
	<th align="center">Home Science Room</th>
	<th align="center">Sick Room</th>
	<th align="center">Store Room</th>
	<th align="center">Library</th>
	<th colspan=3 align="center">Library Type</th>
	
	<th align="center">Staff Room</th>
	<th align="center">Kitchen</th>
	<th align="center">Canteen</th>
	<th align="center">Playground</th>
	<th align="center">Dental Unit</th>
	<th align="center">Bank</th>
	<th colspan=3 align="center">Technical lab</th>
	<th align="center">Technical Faculty</th>
...
<tbody>
<?php
	include('table/school_physical_resource_bd/db.php');
...
$sql = "SELECT * FROM schdata GROUP BY Division ORDER BY Division";
   ...
   <script language="javascript">
       function open_win_editar(targetID) {
           window.open ("table/school_physical_resource_bd/hasil.php?id=" + targetID, "MsgWindow","Editar notícia", "location=1, status=1, scrollbars=1, width=800, height=200");
        }
...
<script src="table/school_physical_resource_bd/table_box.js"></script>
