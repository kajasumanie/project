...
<span class="glyphicon glyphicon-download-alt"></span> Download </button>
     ...
     <div class="modal fade" id="smallModal" tabindex="-1" role="dialog" aria-labelledby="smallModal" aria-hidden="true">
      ...
      <label for="Division">Division</label>
			...
			<a href="index.php?table=school_cot_zws_schs"> reset</a>
...
<tbody>
   ...
   <script language="javascript">
       function open_win_editar(targetID) {
           window.open ("table/school_cot_zws_schs/hasil.php?id=" + targetID, "MsgWindow","Editar notícia", "location=1, status=1, scrollbars=1, width=800, height=200");
        }
...
<script src="table/school_cot_zws_schs/table_box.js"></script>
