...
<script src="table/school_cot_zws_tsps/bootstrap.js"></script
...
<tbody>
   ...
   <script language="javascript">
       function open_win_editar(targetID) {
           window.open ("table/school_cot_zws_tsps/hasil.php?id=" + targetID, "MsgWindow","Editar notícia", "location=1, status=1, scrollbars=1, width=800, height=200");
        }
...
<script src="table/school_cot_zws_tsps/table_box.js"></script>
