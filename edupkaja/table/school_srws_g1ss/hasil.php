...
$id= $_GET['id'];
$sch_name = mysqli_query($con,"select * from schdata where Scid='$id'");
$rows = mysqli_fetch_assoc($sch_name);
$sc_name=$rows['SchoolName'];
echo $id;
...
<div id="container"></div>
  ...
  title: {
      text: 'School wise Result, 2010-2016'
  },
    ...
    plotOptions : {
      series: {
            ...
            point: {
                events: {
                    click: function () {
                        alert('Category: ' + this.category + ', value: ' + this.y+', value: ' + this.name);
                    }
                }
            }
        },
